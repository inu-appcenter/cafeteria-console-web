...
class CafeteriaValidationParams extends GenericItem {
  constructor({
    token = null,
    available_meal_types = null,
    time_range_breakfast = null,
    time_range_lunch = null,
    time_range_dinner = null,
    cafeteria_id = null,
  }) {
    super({});
  ...
  static fields() {
    function shouldBeValidTimeRangeString(timeRangeString) {
      return (
        /^[0-2][0-9]:[0-5][0-9]-[0-2][0-9]:[0-5][0-9]$/.test(timeRangeString) || "Should be in 'mm:hh-mm:hh' format."
      );
    }
